...
class GoalSender:
    def __init__(self):
        ...
        self.waypoints = [
            {'name': 'GOAL_1', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_2', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_3', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_4', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_5', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_6', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_7', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_8', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_9', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_10', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_11', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_12', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_13', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_14', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_15', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_16', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_17', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_18', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
            {'name': 'GOAL_19', 'x': 11.0, 'y': 0.0, 'yaw': 3.14},
            {'name': 'GOAL_20', 'x': -11.0, 'y': 0.0, 'yaw': 0.0},
